    ...
    <div className="auth-page">
      <div className="auth-left">
        <div className="auth-left-content">
          ...
          <h2 className="auth-left-title">Catatan berantakan?<br />Biar AI yang urus.</h2>
          ...
          <div className="auth-left-visual">
            <div className="auth-visual-card">
              <span>📝 → 🧠</span>
              <p>Dari tulisan tangan ke pengetahuan terstruktur</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="auth-right">
        <div className="auth-form-wrapper">
          ...
          <p className="auth-subtitle">Selamat datang kembali! Silakan masuk.</p>
